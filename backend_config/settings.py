...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-w2wsy+u@5xbtris#y588y+p9)dm6ep@6cjl!q-7k*6^wdxk150')
...
if DATABASE_URL:
    # Use PostgreSQL on Render (or any external database)
    DATABASES = {
